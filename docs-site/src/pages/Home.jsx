...
const features = [
  {
    ...
    description: 'Support for both single and multi-select modes with full control over selected values.',
    icon: (
  ...
  },
  {
    ...
    description: 'Replace any visual component with your own renderer. Content, dropdown, items, options, inputs — everything is customizable.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Render the dropdown in any DOM node. Perfect for modals, iframes, or containers with overflow hidden.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Automatically flips the dropdown to open above when there is not enough space below. Works with portals too.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'RTL Support',
    description: 'Full right-to-left layout support with the direction prop. Works with Arabic, Hebrew, and other RTL languages.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Allow users to create custom options on the fly from search input. Perfect for tag inputs and freeform entry.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Full keyboard support with arrow keys, Enter to select, Escape to close, Tab navigation, and Backspace to delete.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Lightweight',
    description: 'Only 2 runtime dependencies (Emotion for CSS-in-JS). Tree-shakable ESM and UMD builds under 20kB.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div className="space-y-16">
      ...
      <div className="text-center space-y-6 py-8">
        ...
        <p className="text-xl text-gray-500 max-w-2xl mx-auto leading-relaxed">
          Customizable, accessible, and performant. With full render-prop overrides,
          portal support, auto-positioning, and keyboard navigation.
        </p>
