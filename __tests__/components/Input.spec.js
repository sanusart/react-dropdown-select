...
describe('Input Component', () => {
  ...
  it.skip('handles focus when dropdown is opened', () => {
    const props = mockProps({
      state: {
        dropdown: true,
      },
  ...
  it.skip('prevents default on arrow key events', () => {
  ...
  it.skip('handles focus with autoFocus and dropdown combination', () => {
    const props = mockProps({
      props: {
        autoFocus: true,
      },
